...
function Hotel() {
  ...
  const [open, setOpen] = useState(false); //Open img slider
  const [openModal, setOpenModal] = useState(false); //Open booking Modal
      ...
      <div className="hotelContainer">
        ...
        <div className="hotelWarpper">
          ...
          <span className="hotelDistance">
            Exccelent location - {data.distance} from center
          </span>
